...
contract Casino {
    ...
    uint16 public minimumBet;
    uint256 public totalBet;
    uint16 public numberOfBets;
    uint16 public maxAmountOfBets = 100;
    ...
    function Casino(uint16 _minimumBet) public {
        owner = msg.sender;
    ...
    function checkPlayerExists(address player) public constant returns(bool) {
        for (uint16 i; i <= players.length; i++) {
    ...
    function bet(uint16 numberSelected) public payable {
    ...
    function distributePrizes(uint256 numberWinner) public {
        ...
        uint16 count = 0; // to count the number of players in the winners array
